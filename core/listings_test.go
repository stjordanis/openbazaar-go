...
func TestVersionForNewListing(t *testing.T) {
	...
	for i, test := range []struct {
		...
		{1, core.PriceModifierListingVersion - 1, pb.Listing_Metadata_FIXED_PRICE, core.PriceModifierListingVersion - 1},
		{1, core.PriceModifierListingVersion + 1, pb.Listing_Metadata_FIXED_PRICE, core.PriceModifierListingVersion + 1},
		{1, core.PriceModifierListingVersion + 7, pb.Listing_Metadata_FIXED_PRICE, core.PriceModifierListingVersion + 7},
